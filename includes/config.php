...
define('SITE_NAME', 'GestionMicro-Dons');
define('SITE_URL', 'https://gestionmicrodons.com');
define('DEFAULT_LANGUAGE', 'fr');
define('SUPPORTED_LANGUAGES', ['fr', 'en']);

// Database Configuration
define('DB_HOST', 'localhost');
define('DB_NAME', 'u834808878_db_microdons');
define('DB_USER', 'u834808878_microdonsbengo');
